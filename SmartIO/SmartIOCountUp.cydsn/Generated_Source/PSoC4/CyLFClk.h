...
*******************************************************************************/
    ...
    #define CY_SYS_TIMER_2ILO_DELAY_US          ((uint16)(134u))
    #define CY_SYS_TIMER_3ILO_DELAY_US          ((uint16)(201u))

    #define CY_SYS_TIMER_1WCO_DELAY_US          ((uint16)( 31u))
    #define CY_SYS_TIMER_2WCO_DELAY_US          ((uint16)( 62u))
    ...
    #define CY_SYS_2TIMER_DELAY_US      \
        ((CY_SYS_CLK_TIMER_SRC_ILO == (CY_SYS_WCO_WDT_CONFIG_REG & CY_SYS_CLK_TIMER_SEL_MASK)) ? \
                                            (CY_SYS_TIMER_2WCO_DELAY_US) : \
                                            (CY_SYS_TIMER_2ILO_DELAY_US))
