// ======================================================================
// 145i2c-capsenseled.v generated from TopDesign.cysch
// 02/27/2016 at 11:57
...
module CapSense_P4_v3_0_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b013e122-a393-42b3-b997-53a535d76dff/77715107-f8d5-47e5-a629-0fb83101ac6b"),
	...
	cy_psoc3_pins_v1_10
		#(.id("b013e122-a393-42b3-b997-53a535d76dff/7850aeaf-db25-4eae-b828-015ef596b59e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("abb53ded-06e6-4fcc-8862-2a8a45002251"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a148a551-30dc-46ce-b840-2f858bded1c3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e9cf1a21-de25-43f2-b1e6-3d5c2dd5eb8b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9bae1e11-8c0e-482c-8b34-3392ed053bcc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("79574dec-e837-47e6-9dbb-bf7c55f76721"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__indicate_net;
	wire [0:0] tmpFB_0__indicate_net;
	wire [0:0] tmpIO_0__indicate_net;
	wire [0:0] tmpINTERRUPT_0__indicate_net;
	electrical [0:0] tmpSIOVREF__indicate_net;

	cy_psoc3_pins_v1_10
		#(.id("7d182053-a805-4939-9350-c8cc35d8e880"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		indicate
		 (.oe(tmpOE__indicate_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__indicate_net[0:0]}),
		  .io({tmpIO_0__indicate_net[0:0]}),
		  .siovref(tmpSIOVREF__indicate_net),
		  .interrupt({tmpINTERRUPT_0__indicate_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__indicate_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("ee524153-9029-4e2a-8c17-30a30999acba"),
		  .source_clock_id(""),
		  .divisor(0),
